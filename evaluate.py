...
from model import Gnss_weighting_visibility_net
import torch
...
if __name__ == "__main__":
    ...
    features = Gnss_weighting_visibility_net.features
    ...
    net = Gnss_weighting_visibility_net(mean=mean,std=std,feat_dim=len(features))
