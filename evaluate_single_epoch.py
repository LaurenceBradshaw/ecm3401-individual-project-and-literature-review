...
#     net = Gnss_single_epoch_net(mean=mean,std=std,feat_dim=len(features))
...
if __name__ == "__main__":
    ...
    for df, truth_df in data_iter:
        ...
        save_name = os.path.basename(os.path.dirname(os.path.dirname(data_iter.get_current_file_path()))) + "_trajectory_map_single_epoch.html"
